      ...
      <td>
            ...
            <?php 
                ...
                {           
                    ...
                    {
                         echo "<img class=\"icon\" src=\"" . $default . "\" onclick=\"javascript: $('#icon').val(this.src); $('#active_icon').attr('src', this.src);\" />&nbsp;";
                         $i = 2;
                    }
                    // others
                    ...
                    { 
                        ...
                        echo "<img class=\"icon\" src=\"" . $icon . "\" onclick=\"javascript: $('#icon').val(this.src); $('#active_icon').attr('src', this.src);\" />&nbsp;";
